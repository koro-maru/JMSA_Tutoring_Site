...
.yellow .rmdp-header,
.yellow .rmdp-panel-header {
  border-bottom: 1px solid var(--rmdp-secondary-yellow);
}
...
.yellow .rmdp-time-picker {
  border-top: 1px solid var(--rmdp-secondary-yellow);
}

.yellow .rmdp-only-time-picker {
  border-top: unset;
}

.yellow .rmdp-panel-body::-webkit-scrollbar-thumb {
  background: var(--rmdp-primary-yellow);
}
...
.yellow .rmdp-rtl .rmpd-panel {
  border-left: unset;
  border-right: 1px solid var(--rmdp-secondary-yellow);
}

.yellow .rmdp-day.rmdp-selected span:not(.rmdp-weekend) {
  background-color: var(--rmdp-primary-yellow);
  box-shadow: 0 0 3px var(--rmdp-shadow-yellow);
}

.yellow .rmdp-day:not(.rmdp-day-hidden):hover span {
