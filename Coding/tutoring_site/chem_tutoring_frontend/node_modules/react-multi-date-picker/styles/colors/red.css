...
.red .rmdp-header,
.red .rmdp-panel-header {
  border-bottom: 1px solid var(--rmdp-secondary-red);
}
...
.red .rmdp-time-picker {
  border-top: 1px solid var(--rmdp-secondary-red);
}

.red .rmdp-only-time-picker {
  border-top: unset;
}
...
.red .rmdp-rtl .rmpd-panel {
  border-left: unset;
  border-right: 1px solid var(--rmdp-secondary-red);
}

.red .rmdp-day.rmdp-selected span:not(.rmdp-weekend) {
  background-color: var(--rmdp-primary-red);
  box-shadow: 0 0 3px var(--rmdp-secondary-red);
}

.red .rmdp-day:not(.rmdp-day-hidden):hover span {
