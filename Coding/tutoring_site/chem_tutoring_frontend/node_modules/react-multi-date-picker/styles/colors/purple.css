...
.purple .rmdp-header,
.purple .rmdp-panel-header {
  border-bottom: 1px solid var(--rmdp-secondary-purple);
}
...
.purple .rmdp-time-picker {
  border-top: 1px solid var(--rmdp-secondary-purple);
}

.purple .rmdp-only-time-picker {
  border-top: unset;
}
...
.purple .rmdp-rtl .rmpd-panel {
  border-left: unset;
  border-right: 1px solid var(--rmdp-secondary-purple);
}

.purple .rmdp-day.rmdp-selected span:not(.rmdp-weekend) {
  background-color: var(--rmdp-primary-purple);
  box-shadow: 0 0 3px var(--rmdp-shadow-purple);
}

.purple .rmdp-day:not(.rmdp-day-hidden):hover span {
